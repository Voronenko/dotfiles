...
files="bashrc conkyrc gitconfig jshintrc jscsrc editorconfig hgrc grcat oh-my-zsh ruby-version ssh-ident screenrc selected_editor tmux.conf vimrc zshrc"    # list of files/folders to symlink in homedir
