...
files="bashrc conkyrc gitconfig jshintrc jscsrc editorconfig oh-my-zsh ruby-version ssh-ident screenrc selected_editor tmux.conf zshrc"    # list of files/folders to symlink in homedir
