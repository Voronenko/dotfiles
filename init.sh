...
files="bashrc condarc direnvrc editorconfig gemrc gitconfig gitignore_global gtkrc-2.0 grcat.mysql grcat.pgsql jshintrc jscsrc hgrc nanorc oh-my-zsh ruby-version screenrc selected_editor tmux.conf tool-versions vimrc zshrc"    # list of files/folders to symlink in homedir
