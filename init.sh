...
files="bashrc direnvrc editorconfig gemrc gitconfig gtkrc-2.0 grcat.mysql grcat.pgsql jshintrc jscsrc hgrc nanorc oh-my-zsh ruby-version ssh-ident screenrc selected_editor tmux.conf vimrc zshrc"    # list of files/folders to symlink in homedir
