...
_doctl_apps_list-alerts()
{
    last_command="doctl_apps_list-alerts"
...
_doctl_apps_propose()
{
    last_command="doctl_apps_propose"
...
_doctl_apps_spec_validate()
{
    ...
    flags+=("--schema-only")
    local_nonpersistent_flags+=("--schema-only")
    flags+=("--access-token=")
    two_word_flags+=("-t")
    flags+=("--api-url=")
    two_word_flags+=("-u")
...
_doctl_apps_update-alert-destinations()
{
    last_command="doctl_apps_update-alert-destinations"
    ...
    flags+=("--app-alert-destinations=")
    local_nonpersistent_flags+=("--app-alert-destinations=")
    flags+=("--format=")
    local_nonpersistent_flags+=("--format=")
    flags+=("--no-header")
    local_nonpersistent_flags+=("--no-header")
...
_doctl_apps()
{
    ...
    commands+=("list-alerts")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("la")
        aliashash["la"]="list-alerts"
    fi
    ...
    commands+=("update-alert-destinations")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("uad")
        aliashash["uad"]="update-alert-destinations"
    fi
...
_doctl_auth_remove()
{
    last_command="doctl_auth_remove"
...
_doctl_compute_droplet_create()
{
    ...
    flags+=("--droplet-agent")
    local_nonpersistent_flags+=("--droplet-agent")
...
_doctl_monitoring_alert_create()
{
    last_command="doctl_monitoring_alert_create"
    ...
    flags+=("--compare=")
    local_nonpersistent_flags+=("--compare=")
    flags+=("--description=")
    ...
    flags+=("--entities=")
    local_nonpersistent_flags+=("--entities=")
    flags+=("--slack-channels=")
    local_nonpersistent_flags+=("--slack-channels=")
    flags+=("--slack-urls=")
    local_nonpersistent_flags+=("--slack-urls=")
    flags+=("--tags=")
...
_doctl_monitoring_alert_delete()
{
    last_command="doctl_monitoring_alert_delete"
...
_doctl_monitoring_alert_get()
{
    last_command="doctl_monitoring_alert_get"
...
_doctl_monitoring_alert_list()
{
    last_command="doctl_monitoring_alert_list"
...
_doctl_monitoring_alert_update()
{
    last_command="doctl_monitoring_alert_update"
...
_doctl_monitoring_alert()
{
    last_command="doctl_monitoring_alert"
...
_doctl_monitoring()
{
    ...
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("a")
        aliashash["a"]="alert"
        command_aliases+=("alerts")
        aliashash["alerts"]="alert"
    fi
