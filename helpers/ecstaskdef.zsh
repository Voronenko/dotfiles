...
function ecstaskdef() {
    ...
    # Step 7: Stage the command that grabs the task definition and copies it to the clipboard
    local command_to_run="aws ${aws_profile_arg} --region=${aws_region} ecs describe-task-definition \
