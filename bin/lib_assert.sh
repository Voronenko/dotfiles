...
source "$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/lib_log.sh"
# shellcheck source=./modules/bash-commons/src/array.sh
source "$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/lib_array.sh"
# shellcheck source=./modules/bash-commons/src/string.sh
source "$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/lib_string.sh"
# shellcheck source=./modules/bash-commons/src/os.sh
source "$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/lib_os.sh"
