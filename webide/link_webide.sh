...
files="config/codestyles/Slavko.xml config/options/code.style.schemes.xml config/templates/angular_basic.xml config/templates/es_basic.xml  config/templates/jasmine_basic.xml"    # list of files/folders to symlink in webide dir
